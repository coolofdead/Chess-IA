    ...
    private void GetErrorMessage(AuthError errorCode)
    {
        switch (errorCode)
        {
            case AuthError.MissingPassword:
                passwordErrorText.text = "Mot de passe manquant.";
                passwordErrorText.enabled = true;
                break;
            case AuthError.WrongPassword:
                passwordErrorText.text = "Mot de passe incorrect.";
                passwordErrorText.enabled = true;
                break;
            case AuthError.InvalidEmail:
                emailErrorText.text = "Email invalide.";
                emailErrorText.enabled = true;
                break;
            case AuthError.MissingEmail:
                emailErrorText.text = "Email manquant.";
                emailErrorText.enabled = true;
                break;
            case AuthError.UserNotFound:
                emailErrorText.text = "Utilisateur introuvable.";
                emailErrorText.enabled = true;
                break;
            default:
                emailErrorText.text = "Une erreur inconnue s'est produit.";
                emailErrorText.enabled = true;
                break;
        }
    }
